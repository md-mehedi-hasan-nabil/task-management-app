...
export default function TaskItem({ task }) {
  ...
  const [isOpenTaskItemModal, setIsOpenTaskItemModal] = useState(false);

  const openTaskItemModal = () => {
    setIsOpenTaskItemModal(true);
  };
  ...
  return (
    <>
      ...
      >
        ...
        <h3 className="text-xl font-semibold line-clamp-2 my-2 capitalize">
          {title}
        </h3>
